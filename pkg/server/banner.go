...
.title{font-size:16px;font-weight:600;letter-spacing:-0.01em;color:var(--fg)}
.subtitle{
font-size:11px;
color:var(--muted);
text-align:center;
...
.footer{font-size:10px;color:var(--muted);opacity:0.5}
</style>
</head>
<body>
<div class="container">
...
<div class="title">KarmaEcho</div>
<div class="subtitle">Out-of-Band interaction server for security testing.<br>Multi-protocol OOB detection with real-time notifications.</div>
</div>
...
<span class="card-value">AES + TLS</span>
</div>
<div class="card-row">
<span class="card-label">Self-Hosted</span>
<span class="card-value">Yes</span>
</div>
</div>

<div style="width:100%%">
<div class="section-title">Supported Protocols</div>
<div class="protocols">
<div class="proto">DNS</div>
<div class="proto">HTTP/S</div>
<div class="proto">WebSocket</div>
<div class="proto">SMTP/S</div>
<div class="proto">LDAP</div>
<div class="proto">FTP/S</div>
<div class="proto">SMB</div>
</div>
</div>

<div class="endpoints">
<div class="section-title">WebSocket Endpoints</div>
<div class="endpoint">
<span class="method">WS</span>
<span class="endpoint-path">wss://[id].%s/ws</span>
<span class="endpoint-desc">Subdomain ID</span>
</div>
<div class="endpoint">
<span class="method">WS</span>
<span class="endpoint-path">wss://%s/ws/[id]</span>
<span class="endpoint-desc">Path ID</span>
</div>
</div>
...
If you observe interactions from <code>*.%s</code> in your logs, your application may have been tested for security vulnerabilities by internal security engineers, penetration testers, or bug bounty hunters. We recommend investigating the source and addressing any identified vulnerabilities.
</div>
</div>
...
<div class="sec-item">AES Encrypted</div>
<div class="sec-item">TLS on All Protocols</div>
<div class="sec-item">Zero Logging</div>
<div class="sec-item">Auto ACME Certs</div>
</div>
</div>

<div class="links">
<a href="https://karmagate.com">Website</a>
<a href="https://github.com/Karmagate/KarmaEcho">GitHub</a>
<a href="https://t.me/karmagate">Telegram</a>
<a href="mailto:support@karmagate.com">Contact</a>
</div>
...
if(r.ok){s.className='badge badge-ok';d.className='badge-dot badge-dot-ok';t.textContent='Online'}
else{fail()}
}).catch(fail);
}
