...
import (
	...
	"github.com/karmagate/karmaecho/pkg/filewatcher"
...
func (h *ResponderServer) ListenAndServe(responderAlive chan bool) error {
	...
	cmdLine := "docker run -p 137:137/udp -p  138:138/udp -p 389:389 -p 1433:1433 -p 1434:1434/udp -p 135:135 -p 139:139 -p 445:445 -p 21:21 -p 3141:3141 -p 110:110 -p 3128:3128 -p 5355:5355/udp -v " + h.tmpFolder + ":/opt/Responder/logs --rm karmaecho:latest"
